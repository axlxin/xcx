<?php 
class ControllerToolmassplayoutupd extends Controller { 
	private $error = array();
	...
	public function index() {
		...
		$this->document->addStyle('view/template/tool/massplayoutupd.css');
...
if ($this->user->hasPermission('modify', 'tool/massplayoutupd')) { /// modify permision
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		$data['action'] = $this->url->link('tool/massplayoutupd', 'token=' . $this->session->data['token'], 'SSL');

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		
		$this->response->setOutput($this->load->view('tool/massplayoutupd.tpl', $data));
	}
