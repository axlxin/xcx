...
class ControllerToolmasspstockupd extends Controller { 
	...
	public function index() {
		...
		$this->document->addStyle('view/template/tool/masspstockupd.css');
...
$this->session->data['success'] = $this->language->get('masstxt_succes_products_filtered');
		...
		$data['action'] = $this->url->link('tool/masspstockupd', 'token=' . $this->session->data['token'], 'SSL');

		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		
		$this->response->setOutput($this->load->view('tool/masspstockupd.tpl', $data));
	}
