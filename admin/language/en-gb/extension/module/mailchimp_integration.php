...
$_['help_merge_tags']					= 'Select the field that will be filled in for each list\'s merge tag when subscribing the customer. To fill in the full customer address for an ADDRESS merge tag, select <code>address_id</code>.';
...
$_['entry_testing_mode']				= 'Testing Mode: <div class="help-text">Enabling this will log errors and webhook calls to this log. If you choose "Enabled with full logging" then all API requests and responses will also be logged to this log.</div>';
