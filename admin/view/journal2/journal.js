...
define('controllers/blog/posts/form',['./../../module', 'underscore'], function (module, _) {
    ...
    module.controller('BlogPostsFormController', function ($scope, $routeParams, $location, $timeout, localStorageService, Spinner, Rest) {
        ...
        $scope.addRelatedPost = function () {
            $scope.post_data.related_posts = $scope.post_data.related_posts || [];
            $scope.post_data.related_posts.push({});
        };
        
        /* remove related posts */
        $scope.removeRelatedPost = function ($index) {
            $scope.post_data.related_posts.splice($index, 1);
        };
