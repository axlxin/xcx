    ...
    <accordion id="main-accordion" close-others="accordion.close_others">
        ...
        <accordion-group is-open="accordion.details_is_open">
            ...
            <ul class="module-create-options">
                ...
                <li>
                    <span class="module-create-title">Short Description</span>
                    <span class="module-create-option">
                        <j-opt-textarea-lang data-ng-model="post_data.short_description"></j-opt-textarea-lang>
                    </span>
                </li>
            </ul>
        </accordion-group>
        ...
        <accordion-group is-open="accordion.links_is_open">
            ...
            <ul class="module-create-options">
                ...
                <li>
                    <span class="module-create-title">Related Post</span>
                    <span class="module-create-option">
                         <ul class="simple-list">
                             <li data-ng-repeat="related_post in post_data.related_posts">
                                 <blog-post-search model="related_post.data"></blog-post-search>
                                 <a class="btn red delete" href="javascript:;" data-ng-click="removeRelatedPost($index)">X</a>
                             </li>
                         </ul>
                        <a href="javascript:;" class="btn blue add-post" data-ng-click="addRelatedPost()">Add</a>
                    </span>
                </li>
            </ul>
        </accordion-group>
