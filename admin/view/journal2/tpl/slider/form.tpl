...
<div class="module-body module-form">
    ...
    <accordion close-others="module_data.close_others">
        ...
        <accordion-group data-ng-repeat="slide in module_data.slides track by slide.slide_id" is-open="slide.is_open">
            <accordion-heading>
                        ...
                        <span class="module-create-option">
                            <select ui-select2="" data-ng-model="slide.transition">
                                <optgroup data-ng-repeat="transition_group in transitions" label="{{transition_group.type}}">
                                    <option data-ng-repeat="tr in transition_group.transitions track by tr.id" value="{{tr.id}}">{{tr.name}}</option>
                                </optgroup>
                            </select>
                        </span>
                    </li>
                    <li>
                        ...
                        <span class="module-create-option">
                            <select ui-select2="" data-ng-model="slide.easing">
                                <option data-ng-repeat="easing in easings track by $index" value="{{easing}}">{{easing}}</option>
                            </select>
                        </span>
                    </li>
                    <li>
            ...
            <accordion close-others="slide.close_others">
                <accordion-group data-ng-repeat="caption in slide.captions track by caption.caption_id" is-open="caption.is_open">
                    <accordion-heading>
                            ...
                            <ul class="module-create-options">
                                ...
                                <span class="module-create-option">
                                    <select ui-select2="" data-ng-model="caption.animation_in">
                                        <option data-ng-repeat="a in incoming_caption_animations track by a.id" value="{{a.id}}">{{a.name}}</option>
                                    </select>
                                </span>
                                </li>
                                ...
                                <span class="module-create-option">
                                    <select ui-select2="" data-ng-model="caption.animation_out">
                                        <option data-ng-repeat="a in outgoing_caption_animations track by a.id" value="{{a.id}}">{{a.name}}</option>
                                    </select>
                                </span>
                                </li>
