                        ...
                        <div class="col-md-4">
                            ...
                            <div class="thumbnail">
                                ...
                                <div class="caption" style="text-align:center;padding-top:0px;">
                                    ...
                                    <p style="padding-top: 5px;"><a href="http://isenselabs.com/tickets/open/<?php echo base64_encode('Support Request').'/'.base64_encode('141').'/'. base64_encode($_SERVER['SERVER_NAME']); ?>" target="_blank" class="btn btn-lg btn-default">Open a support ticket</a></p>
