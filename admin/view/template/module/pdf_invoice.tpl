	...
	<div id="stores" <?php if ($OC_V2) echo 'class="v2"'; ?>>
      ...
      <tr>
				...
				<td class="checkbox_list">
						...
						<label><input type="checkbox" name="pdf_invoice_return_pdf[]" value="<?php echo $return_status['return_status_id']; ?>" <?php if (in_array($return_status['return_status_id'], (array) $pdf_invoice_return_pdf)) echo ' checked="checked"'; ?>/> <?php echo $return_status['name']; ?></label>
						<?php } ?>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td>
					<select name="pdf_invoice_force_lang">
						<option value=""><?php echo $_language->get('text_order_language'); ?></option>
					<?php foreach ($languages as $language) { ?>
			  ...
			  <td colspan="2">
					<ul class="nav nav-tabs">
						<?php $f=0; foreach ($languages as $language) { ?>
							<li<?php if(!$f) { echo ' class="active"'; $f=1;} ?>><a href="#tab-language-<?php echo  $language['code']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" alt=""/> <?php echo $language['name']; ?></a></li>
						<?php } ?>
					</ul>
					<div class="tab-content">
						<?php $f=0; foreach ($languages as $language) { ?>
		...
		<div class="tab-pane" id="tab-2">
			<table class="form">
				...
				<tr>
				  ...
				  <td><select name="pdf_invoice_template">
				...
				<tr>
				  ...
				  <td><select name="pdf_invoice_totals_tax">
		...
		<div class="tab-pane" id="tab-4">
			...
			<div class="tab-content col-md-10">
				...
				<div class="tab-pane <?php if($module_row === 1) echo ' active'; ?>" id="tab-module-<?php echo $module_row; ?>" class="vtabs-content">
					<ul class="nav nav-tabs">
						<?php $f=0; foreach ($languages as $language) { ?>
							<li class="<?php if(!$f) echo ' active'; $f=1; ?>"><a href="#tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
						<?php } ?>
					</ul>
				   <div class="tab-content">
					  <?php $f=0; foreach ($languages as $language) { ?>
					  <div class="tab-pane<?php if(!$f) echo ' active'; $f=1; ?>" id="tab-language-<?php echo $module_row; ?>-<?php echo $language['language_id']; ?>">
						<table class="form">
						 <tr>
							...
							<td><input type="text" name="pdf_invoice_blocks[<?php echo $module_row; ?>][title][<?php echo $language['language_id']; ?>]; ?>" value="<?php echo isset($module['title'][$language['language_id']]) ? $module['title'][$language['language_id']] : ''; ?>" size="63"/></td>
						 </tr>
						  <tr>
                ...
                <?php } ?>
				  ...
				  <table class="form">
					<tr>
					  ...
					  <td><select name="pdf_invoice_blocks[<?php echo $module_row; ?>][position]">
					...
					<tr>
					  ...
					  <td><select name="pdf_invoice_blocks[<?php echo $module_row; ?>][display]">
            ...
            <optgroup label="<?php echo $_language->get('entry_display_comment'); ?>">
					...
					<tr>
					  ...
					  <td><input type="text" name="pdf_invoice_blocks[<?php echo $module_row; ?>][sort_order]" value="<?php echo $module['sort_order']; ?>" size="3" /></td>
					</tr>
				  </table>
				</div>
				<?php $module_row++; ?>
      ...
      <div class="clearfix"></div>
		...
		<div class="tab-pane" id="tab-5">
			<table class="form">
				...
				<tr>
				  <td><?php echo $_language->get('entry_template'); ?></td>
				  <td><select name="pdf_invoice_sliptemplate">
        ...
        <tr>
          ...
          <input class="switch" type="checkbox" id="pdf_invoice_slip_summary" name="pdf_invoice_slip_summary" value="1" <?php if($_config->get('pdf_invoice_slip_summary')) echo 'checked="checked"'; ?>/>
            ...
            <div>
              	<?php echo $_language->get('entry_barcode_type'); ?>
                <select class="form-control" name="pdf_invoice_slip_barcode[type]">
                <?php foreach ($barcode_types as $bcode) { ?>
            ...
            <div>
              	<?php echo $_language->get('entry_barcode_value'); ?>
                <select class="form-control" name="pdf_invoice_slip_barcode[value]">
		...
		<div class="tab-pane" id="tab-3">
			<table class="form">
				...
				<tr>
					...
					<td>
						<select name="pdf_invoice_backup_moment">
				...
				<tr>
					...
					<td>
						<select name="pdf_invoice_backup_structure">
				...
				<tr>
					<td><?php echo $_language->get('entry_size'); ?></td>
					<td>
						<select name="pdf_invoice_backup_size">
				...
				<tr>
					...
					<td>
						<div class="inlineEdit">
							...
							<div class="switchContent">
								<img style="position:relative;top:3px" src="<?php echo $_img_path; ?>pdf.png" alt="filename"/>
								<input type="text" name="pdf_invoice_backup_prefix" value="<?php echo $pdf_invoice_backup_prefix; ?>"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					...
					<td>
						<div class="inlineEdit">
							...
							<div class="switchContent">
								<img style="position:relative;top:2px" src="<?php echo $_img_path; ?>directory.png" alt="folder"/> <input type="text" name="pdf_invoice_backup_folder" value="<?php echo $pdf_invoice_backup_folder; ?>" size="63"/>
			...
			<table class="form about">
				...
				<tr>
					...
					<td>
						...
						<!-- links -->
						<b>Module page :</b> <a target="new" href="http://www.opencart.com/index.php?route=extension/extension/info&extension_id=15075">PDF Invoice Pro</a><br/>
...
$('select[name=store]').change(function(){
	document.location = 'index.php?route=module/pdf_invoice&token=<?php echo $token; ?>&store_id='+$(this).val();
});
...
function addModule() {	
    ...
    <?php $f=0; foreach ($languages as $language) { ?>
    html += '    <li class="<?php if(!$f) echo ' active'; $f=1; ?>"><a href="#tab-language-'+ module_row + '-<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>';
    <?php } ?>
	html += '  </ul>';
	...
	html += '          <td><input type="text" name="pdf_invoice_blocks[' + module_row + '][title][<?php echo $language['language_id']; ?>]; ?>" size="63"/></td>';
	html += '        </tr>';
	html += '        <tr>';
  ...
  <?php } ?>
	...
	html += '      <td><select name="pdf_invoice_blocks[' + module_row + '][position]">';
	...
	html += '      <td><select name="pdf_invoice_blocks[' + module_row + '][display]">';
	...
	html += '      <td><input type="text" name="pdf_invoice_blocks[' + module_row + '][sort_order]" value="" size="3" /></td>';
	html += '    </tr>';
	html += '  </table>'; 
	html += '</div>';
...
$('body').on('click', '.info-btn', function() {
  ...
  $('#modal-info').load('index.php?route=module/pdf_invoice/modal_info&token=<?php echo $token; ?>', {'info': $(this).attr('data-info')});
});
//--></script> 
<?php if(!$OC_V2) { ?>
<script type="text/javascript"><!--
