<div class="container-fluid">
    <div class="row">
        <div class="col-md-4">
            ...
            <?php if (empty($data['SignUpCoupons']['LicensedOn'])): ?>
                ...
                <tr>
                    <td colspan="2">
                        <div class="form-group">
                            ...
                            <input type="text" class="licenseCodeBox form-control" placeholder="License Code e.g. XXXXXX-XXXXXX-XXXXXX-XXXXXX-XXXXXX" name="SignUpCoupons[LicenseCode]" id="moduleLicense" value="<?php echo !empty($data['SignUpCoupons']['LicenseCode']) ? $data['SignUpCoupons']['LicenseCode'] : ''?>" />
                        </div>
            ...
            <?php endif; ?>
            <?php if (!empty($data['SignUpCoupons']['LicensedOn'])): ?>
            <input name="cHRpbWl6YXRpb24ef4fe" type="hidden" value="<?php echo base64_encode(json_encode($data['SignUpCoupons']['License'])); ?>" />
            <input name="OaXRyb1BhY2sgLSBDb21" type="hidden" value="<?php echo $data['SignUpCoupons']['LicensedOn']; ?>" />
            <table class="table licensedTable">
                <tr>
                    <td>License Holder</td>
                    <td><?php echo $data['SignUpCoupons']['License']['customerName']; ?></td>
                </tr>
                <tr>
                    <td>Registered domains</td>
                    <td>
                        <ul class="registeredDomains">
                            <?php foreach ($data['SignUpCoupons']['License']['licenseDomainsUsed'] as $domain): ?>
                ...
                <tr>
                    ...
                    <td><?php echo date("F j, Y",strtotime($data['SignUpCoupons']['License']['licenseExpireDate'])); ?></td>
                </tr>
                <tr>
            ...
            <div class="box-contents">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <img alt="Community support" style="width: 300px;" src="view/image/signupcoupons/community.png">
                        ...
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <img data-src="holder.js/300x200" alt="Ticket support" style="width: 300px;" src="view/image/signupcoupons/tickets.png">
                                <div class="caption" style="text-align:center;padding-top:0px;">
                                    <h3>Tickets</h3>
                                    <p>Want to comminicate one-to-one with our tech people? Then open a support ticket.</p>
                                    <p style="padding-top: 5px;"><a href="http://isenselabs.com/tickets/open/<?php echo base64_encode('Support Request').'/'.base64_encode('112').'/'. base64_encode($_SERVER['SERVER_NAME']); ?>" target="_blank" class="btn btn-lg btn-default">Open a support ticket</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="thumbnail">
                                <img alt="Pre-sale support" style="width: 300px;" src="view/image/signupcoupons/pre-sale.png">
                                <div class="caption" style="text-align:center;padding-top:0px;">
                                    <h3>Pre-sale</h3>
