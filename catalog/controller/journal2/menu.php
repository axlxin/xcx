...
class ControllerJournal2Menu extends Controller {
                                ...
                                case 'products':
                                    ...
                                    foreach ($products as $product) {
                                        ...
                                        $products_data[] = array(
                                            ...
                                            'href'          => $this->url->link('product/product', 'product_id=' . $product['product_id'], $this->config->get('config_secure')),
                                ...
                                case 'posts':
                                    ...
                                    foreach ($posts as $post) {
                                        $posts_data[] = array(
                                            ...
                                            'href'          => $this->url->link('journal2/blog/post', 'journal_blog_post_id=' . $post['post_id'], $this->config->get('config_secure'))
                                        );
                                    }
        ...
        foreach ($items as $key => &$item) {
            ...
            switch ($item['menu']['menu_type']) {
                case 'category':
                    ...
                    $href = $this->url->link('product/category', 'path=' . $category_info['category_id'], $this->config->get('config_secure'));
                    break;
                case 'product':
                    ...
                    $href = $this->url->link('product/product', 'product_id=' . $product_info['product_id'], $this->config->get('config_secure'));
                    break;
                case 'manufacturer':
                    ...
                    $href = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $manufacturer_info['manufacturer_id'], $this->config->get('config_secure'));
                    break;
                case 'information':
                    ...
                    $href = $this->url->link('information/information', 'information_id=' .  $information_info['information_id'], $this->config->get('config_secure'));
                    break;
                case 'popup':
                    ...
                    switch ($item['menu']['menu_item']['page']) {
                        ...
                        case 'register':
                            ...
                            if(!$this->customer->isLogged()){
                                $icon['left'] = preg_replace("/data-icon=\".+\"/", "data-icon=\"&#xe045;\"", $icon['left']);
                                $icon['right'] = preg_replace("/data-icon=\".+\"/", "data-icon=\"&#xe045;\"", $icon['right']);
                            }
                            break;
                ...
                case 'blog_home':
                    ...
                    $href = $this->url->link('journal2/blog', '', $this->config->get('config_secure'));
                    break;
                case 'blog_category':
                    $category_info = $this->model_journal2_blog->getCategory(Journal2Utils::getProperty($item, 'menu.menu_item.id', -1));
                    if (!$category_info) continue;
                    $name = $category_info['name'];
                    $href = $this->url->link('journal2/blog', 'journal_blog_category_id=' . $category_info['category_id'], $this->config->get('config_secure'));
                    break;
                case 'blog_post':
                    $post_info = $this->model_journal2_blog->getPost(Journal2Utils::getProperty($item, 'menu.menu_item.id', -1));
                    if (!$post_info) continue;
                    $name = $post_info['name'];
                    $href = $this->url->link('journal2/blog/post', 'journal_blog_post_id=' . $post_info['post_id'], $this->config->get('config_secure'));
                    break;
                case 'custom':
            ...
            $menu_item_page = isset($item['menu']['menu_item']['page']) ? $item['menu']['menu_item']['page'] : '';
            $item = array(
                'icon_left' => $icon['left'],
                'icon_right'=> $icon['right'],
                    ...
                    case 'megamenu':
                        ...
                        switch (Journal2Utils::getProperty($menu_item, 'categories.type')) {
                            ...
                            case 'existing':
                                ...
                                $menu['href'] = $this->url->link('product/category', 'path=' . $parent_category['category_id'], $this->config->get('config_secure'));
                                switch ($links_type) {
                                    case 'categories':
                                        ...
                                        foreach ($subcategories as $subcategory) {
                                            ...
                                            foreach ($sub_categories as $sub_category) {
                                                $submenu[] = array(
                                                    ...
                                                    'href' => $this->url->link('product/category', 'path=' . $parent_category['category_id'] . '_' . $subcategory['category_id'] . '_' . $sub_category['category_id'], $this->config->get('config_secure')),
                                            ...
                                            $menu['items'][] = array(
                                                ...
                                                'href' => $this->url->link('product/category', 'path=' . $parent_category['category_id'] . '_' . $subcategory['category_id'], $this->config->get('config_secure')),
                                                'items' => $submenu,
                                    ...
                                    case 'products':
                                        ...
                                        foreach ($subcategories as $subcategory) {
                                            ...
                                            foreach ($sub_categories as $sub_category) {
                                                $submenu[] = array(
                                                    'name' => $sub_category['name'],
                                                    'href' => $this->url->link('product/product', 'path=' . $parent_category['category_id'] . '_' . $subcategory['category_id'] . '&product_id=' . $sub_category['product_id'], $this->config->get('config_secure')),
                                                    'image' => Journal2Utils::resizeImage($this->model_tool_image, $sub_category, $image_width, $image_height, $image_resize_type),
                                    ...
                                    case 'categories':
                                        ...
                                        foreach (Journal2Utils::getProperty($menu_item, 'categories.items', array()) as $category) {
                                            ...
                                            foreach ($sub_categories as $sub_category) {
                                                $submenu[] = array(
                                                    'name' => $sub_category['name'],
                                                    'href' => $this->url->link('product/category', 'path=' . $parent_category['category_id'] . '_' . $sub_category['category_id'], $this->config->get('config_secure')),
                                                    'image' => Journal2Utils::resizeImage($this->model_tool_image, $sub_category, $image_width, $image_height, $image_resize_type),
                                                    'image_width' => $image_width ? $image_width : 100,
                                                    'image_height' => $image_height ? $image_height : 100,
                                                    'dummy' => Journal2Utils::resizeImage($this->model_tool_image, 'data/journal2/transparent.png', $image_width, $image_height, 'fit')
                                            ...
                                            $menu['items'][] = array(
                                                ...
                                                'href' => $this->url->link('product/category', 'path=' . $parent_category['category_id'], $this->config->get('config_secure')),
                                    ...
                                    case 'products':
                                        ...
                                        foreach (Journal2Utils::getProperty($menu_item, 'categories.items', array()) as $category) {
                                            ...
                                            foreach ($sub_categories as $sub_category) {
                                                $submenu[] = array(
                                                    'name' => $sub_category['name'],
                                                    'href' => $this->url->link('product/product', 'path=' . $parent_category['category_id'] . '&product_id=' . $sub_category['product_id'], $this->config->get('config_secure')),
                                                    'image' => Journal2Utils::resizeImage($this->model_tool_image, $sub_category, $image_width, $image_height, $image_resize_type),
                                                    'image_width' => $image_width ? $image_width : $this->config->get('config_image_product_width'),
                                                    'image_height' => $image_height ? $image_height : $this->config->get('config_image_product_height'),
                                                    'dummy' => Journal2Utils::resizeImage($this->model_tool_image, 'data/journal2/transparent.png', $image_width, $image_height, 'fit'),
            ...
            case 'products':
                ...
                switch (Journal2Utils::getProperty($menu_item, 'products.source')) {
                    ...
                    case 'category':
                        ...
                        foreach ($products as $product) {
                            $menu['items'][] = array(
                                ...
                                'labels' => $this->model_journal2_product->getLabels($product['product_id']),
                                'name' => $product['name'],
                                'href' => $this->url->link('product/product', 'path=' . $parent_category['category_id'] . '&product_id=' . $product['product_id'], $this->config->get('config_secure')),
                    ...
                    case 'manufacturer':
                        ...
                        $menu['href'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $manufacturer['manufacturer_id'], $this->config->get('config_secure'));
                        ...
                        foreach ($products as $product) {
                            $menu['items'][] = array(
                                ...
                                'labels' => $this->model_journal2_product->getLabels($product['product_id']),
                                'name' => $product['name'],
                                'href' => $this->url->link('product/product', '&manufacturer_id=' . $manufacturer['manufacturer_id'] . '&product_id=' . $product['product_id'], $this->config->get('config_secure')),
                                'image' => Journal2Utils::resizeImage($this->model_tool_image, $product, $image_width, $image_height, $image_resize_type),
                                'image_width' => $image_width ? $image_width : $this->config->get('config_image_product_width'),
                                'image_height' => $image_height ? $image_height : $this->config->get('config_image_product_height'),
                                'dummy' => Journal2Utils::resizeImage($this->model_tool_image, 'data/journal2/transparent.png', $image_width, $image_height, 'fit'),
                    ...
                    case 'custom':
                        ...
                        foreach ($products as $product) {
                            ...
                            $menu['items'][] = array(
                                ...
                                'name' => $result['name'],
                                'href' => $this->url->link('product/product', '&product_id=' . $result['product_id'], $this->config->get('config_secure')),
            ...
            case 'custom':
                ...
                switch (Journal2Utils::getProperty($menu_item, 'custom.top.menu_type')) {
                    case 'category':
                        ...
                        $menu['href'] = $this->url->link('product/category', 'path=' . $category_info['category_id'], $this->config->get('config_secure'));
                    ...
                    case 'product':
                        ...
                        $menu['href'] = $this->url->link('product/product', 'product_id=' . $product_info['product_id'], $this->config->get('config_secure'));
                        $menu['subcategories'] = $this->generateMenu(Journal2Utils::getProperty($menu_item, 'custom.items', array()));
                        break;
                    case 'manufacturer':
                        ...
                        $menu['href'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $manufacturer_info['manufacturer_id'], $this->config->get('config_secure'));
                        $menu['subcategories'] = $this->generateMenu(Journal2Utils::getProperty($menu_item, 'custom.items', array()));
                        break;
                    case 'information':
                        ...
                        $menu['href'] = $this->url->link('information/information', 'information_id=' . $information_info['information_id'], $this->config->get('config_secure'));
                        $menu['subcategories'] = $this->generateMenu(Journal2Utils::getProperty($menu_item, 'custom.items', array()));
                        break;
                    case 'opencart':
                        $customer_name = null;
                    ...
                    case 'blog_home':
                        ...
                        $menu['href'] = $this->url->link('journal2/blog', '', $this->config->get('config_secure'));
                        $menu['subcategories'] = $this->generateMenu(Journal2Utils::getProperty($menu_item, 'custom.items', array()));
                        break;
                    case 'blog_category':
                        ...
                        if (!$category_info) continue;
                        $menu['name'] = $category_info['name'];
                        $menu['href'] = $this->url->link('journal2/blog', 'journal_blog_category_id=' . $category_info['category_id'], $this->config->get('config_secure'));
                        $menu['subcategories'] = $this->generateMenu(Journal2Utils::getProperty($menu_item, 'custom.items', array()));
                        break;
                    case 'blog_post':
                        ...
                        $menu['href'] = $this->url->link('journal2/blog/post', 'journal_blog_post_id=' . $post_info['post_id'], $this->config->get('config_secure'));
                        $menu['subcategories'] = $this->generateMenu(Journal2Utils::getProperty($menu_item, 'custom.items', array()));
                        break;
                    case 'custom':
                        $menu['name'] = Journal2Utils::getProperty($menu_item, 'custom.menu_item.name.value.' . $this->config->get('config_language_id'), 'Not Translated');
    ...
    private function generateMultiLevelCategoryMenu ($category_id, $path = '') {
        ...
        foreach ($categories as $category) {
            $result[] = array(
                'href'			=> $this->url->link('product/category', 'path=' . $path . '_' . $category['category_id'], $this->config->get('config_secure')),
                'new_window'	=> 0,
                'name'			=> $category['name'],
