...
class ControllerJournal2Quickview extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->get['path'])) {
			...
			foreach ($parts as $path_id) {
				...
				if ($category_info) {
					$this->data['breadcrumbs'][] = array(
						...
						'href'      => $this->url->link('product/category', 'path=' . $path, $this->config->get('config_secure')),
			...
			if ($category_info) {			
				...
				$this->data['breadcrumbs'][] = array(
					'text'      => $category_info['name'],
					'href'      => $this->url->link('product/category', 'path=' . $this->request->get['path'], $this->config->get('config_secure')),
					'separator' => $this->language->get('text_separator')
				);
			}
		}
		...
		if (isset($this->request->get['manufacturer_id'])) {
			$this->data['breadcrumbs'][] = array( 
				...
				'href'      => $this->url->link('product/manufacturer', '', $this->config->get('config_secure')),
				'separator' => $this->language->get('text_separator')
			);	
			...
			if ($manufacturer_info) {	
				$this->data['breadcrumbs'][] = array(
					...
					'href'	    => $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $this->request->get['manufacturer_id'] . $url, $this->config->get('config_secure')),					
					'separator' => $this->language->get('text_separator')
				);
			}
		}
		...
		if (isset($this->request->get['search']) || isset($this->request->get['tag'])) {
			...
			$this->data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('product/search', $url, $this->config->get('config_secure')),
				'separator' => $this->language->get('text_separator')
			); 	
		}
		...
		if ($product_info) {
			...
			$this->data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('product/product', $url . '&product_id=' . $this->request->get['pid'], $this->config->get('config_secure')),
				'separator' => $this->language->get('text_separator')
			);			
			...
			$this->document->addLink($this->url->link('product/product', 'product_id=' . $this->request->get['pid'], $this->config->get('config_secure')), 'canonical');
			...
			$this->data['manufacturers'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $product_info['manufacturer_id'], $this->config->get('config_secure'));
			...
			if ($product_info['tag']) {		
				...
				foreach ($tags as $tag) {
					$this->data['tags'][] = array(
						'tag'  => trim($tag),
						'href' => $this->url->link('product/search', 'tag=' . trim($tag), $this->config->get('config_secure'))
					);
				}
			}
			...
			$this->response->setOutput($this->render());
      		...
      		$this->data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('journal2/quickview', '&pid=' . $product_id, $this->config->get('config_secure')),
        		'separator' => $this->language->get('text_separator')
      		);			
    ...
    private function index2() {
		...
		if ($product_info) {
			...
			$data['manufacturers'] = $this->url->link('product/manufacturer/info', 'manufacturer_id=' . $product_info['manufacturer_id'], $this->config->get('config_secure'));
        ...
        $data['labels'] = $this->model_journal2_product->getLabels($product_info['product_id']);
			...
			$data['continue'] = $this->url->link('common/home', '', $this->config->get('config_secure'));
