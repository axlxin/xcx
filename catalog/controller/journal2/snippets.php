        ...
        switch ($this->journal2->page->getType()) {
            case 'product':
                ...
                if ($product_info) {
                    ...
                    $this->s_url = $this->url->link('product/product', 'product_id=' . $this->journal2->page->getId(), $this->config->get('config_secure'));
                    ...
                    $pagination->url = $this->url->link('product/product/review', 'product_id=' . $this->request->get['product_id'] . '&page={page}', $this->config->get('config_secure'));
            ...
            case 'category':
                ...
                if ($category_info) {
                    ...
                    $this->s_url = $this->url->link('product/category', 'path=' . $category_id, $this->config->get('config_secure'));
                }
                break;
            ...
            case 'journal-blog-post':
                ...
                $this->s_url = $this->url->link('journal2/blog/post', 'journal_blog_post_id=' . $this->journal2->page->getId(), $this->config->get('config_secure'));
                break;
        }
