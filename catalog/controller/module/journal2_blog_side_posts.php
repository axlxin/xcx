        ...
        if ($cache === null || self::$CACHEABLE !== true || $hash === null) {
            ...
            switch ($module_type) {
                ...
                case 'views':
                    ...
                    break;
                case 'related':
                    // 2017年10月8日 修改此功能，把“查找商品的相关博文”改为“查找某博文的其他相关博文”
                    if (isset($this->request->get['journal_blog_post_id']) && $this->request->get['route'] === 'journal2/blog/post') {
                        $posts = $this->model_journal2_blog->getPostRelatedPosts($this->request->get['journal_blog_post_id'], $limit);
                    }
                    break;
                case 'custom':
