    ...
    public function index($setting) {
        ...
        if ($cache === null || self::$CACHEABLE !== true) {
            ...
            if ($this->data['type'] === 'contact') {
                ...
                $this->data['action'] = $this->url->link('information/contact', '', $this->config->get('config_secure'));
                $this->data['captcha'] = '';
                /* reset oc variables */
    ...
    public function contact() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if (isset($this->request->post['product_id'])) {
                $from = $this->url->link('product/product', 'product_id=' . $this->request->post['product_id'], $this->config->get('config_secure'));
