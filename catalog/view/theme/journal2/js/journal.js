...
Journal.setupMenu = function (type) {
    ...
    if (type === 'tablet' || type === 'desktop') {
        ...
        $supermenu.hoverIntent(function () {
            ...
            if($('> ul, > div', this).length>0){
                $("#top-modules").css({"position": "relative"});
                $("#top-modules, .extended-container").prepend("<div class='menu-mask'></div>");
                $(".menu-mask").animate({'opacity': 0.8});
            }
        }, function () {
...
Journal.onTablet = function () {
    ...
    $('#mini-menu-toggle').off("click mouseenter");
    $('#mini-menu-toggle').on('click', function(){
        var _this = $(this);
        if(_this.hasClass("opened")){
            _this.removeClass("opened").addClass("closed");
            $(".journal-menu,.journal-menu-bg").removeClass("opened");
        }else{
            _this.removeClass("closed").addClass("opened");
            $(".journal-menu,.journal-menu-bg").addClass("opened");
        }
    });
    $("#mini-menu-toggle").on("mouseenter", function(){
        var _this = $(this);
        _this.removeClass("closed").addClass("opened");
        $(".journal-menu,.journal-menu-bg").addClass("opened");
    });
            ...
            if (!$('html').hasClass('noscroll')) {
                if (!$('header').hasClass('sticky-off')) {
                    if ($(window).scrollTop() > 40) {
                        ...
                        $("#mini-menu-toggle, .journal-menu, .journal-menu-bg").removeClass("opened");
