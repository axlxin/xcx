...
<link rel="stylesheet" href="catalog/view/theme/journal2/css/kp_productPcb.css"/>
<script type="text/javascript" src="catalog/view/theme/journal2/js/kp_productPcb.js"></script>
</head>
<body>
<!--[if lt IE 9]>
