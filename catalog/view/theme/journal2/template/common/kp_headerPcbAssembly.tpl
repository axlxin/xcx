...
<link rel="stylesheet" href="catalog/view/theme/journal2/css/kp_productPcbAssembly.css"/>
<script type="text/javascript" src="catalog/view/theme/journal2/js/kp_productPcbAssembly.js"></script>
</head>
<body>
<!--[if lt IE 9]>
