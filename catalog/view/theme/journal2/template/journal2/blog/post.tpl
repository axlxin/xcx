...
<div id="content" class="blog-post">
    ...
    <div class="post-stats comment-date">
        ...
        <span class="" style="margin-right: 0;"><?php echo $post_author; ?>,</span>
        <?php endif; ?>
        <span class=""><?php echo date($date_format_short, strtotime($post_date)); ?></span>
        <!--<span class="p-comment"><?php echo count($comments); ?> <?php echo $this->journal2->settings->get('blog_comment_text', 'Comment(s)'); ?></span>-->
        <?php if ($post_categories && 0): ?>
            ...
            <div class="box-product">
                ...
                <div class="product-grid-item <?php echo $carousel ? '' : $grid_classes; ?> display-<?php echo $this->journal2->settings->get('product_grid_wishlist_icon_display'); ?> <?php echo $this->journal2->settings->get('product_grid_button_block_button'); ?>">
                    <div class="product-thumb product-wrapper">
                        <div class="product-thumb-over">
                            <h4 class="over-name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></h4>
                            <a class="short_description" href="<?php echo $product['href']; ?>"><?php echo $product['short_description']; ?></a>
