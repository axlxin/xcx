                                            ...
                                            <div class='row product-option'>
                                                ...
                                                <div class="xl-75">
                                                    <div class="option option-<?php echo $option['type']; ?>">
                                                        <input type="text" name="option[<?php echo $option['product_option_id']; ?>]" value="<?php echo $option['value']; ?>" placeholder="length" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control" /> &times;
                                                        <input type="text" name="option[<?php echo $d_nextOption['product_option_id']; ?>]" value="<?php echo $d_nextOption['value']; ?>" placeholder="width" id="input-option<?php echo $d_nextOption['product_option_id']; ?>" class="form-control" /> mm
                                                    </div>
                                                </div>
