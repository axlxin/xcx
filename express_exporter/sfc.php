...
require_once('sfc_orderReader.php');
...
$objPHPExcel->getProperties()->setCreator("Kevin Pan")
    ...
    ->setTitle("Opencart orders 2 SFC Data")
    ->setSubject("Opencart orders 2 SFC Data")
    ->setDescription("This document created by KP_expressDataExporter.")
    ->setKeywords("sfc excel")
    ->setCategory("sfc excel");
...
header('Content-Disposition: attachment;filename="oc_orders_SFC_' . date("ymd") . '.xls"');
