...
class Mail {
	...
	public function addAttachment($filename) {
		$this->attachments[] = $filename;
          ...
          protected $orderreviews_bcc;       

          public function setOrderReviewsBcc($orderreviews_bcc) {
            $this->orderreviews_bcc = $orderreviews_bcc;
          }
	...
	public function send() {
		...
		$header = 'MIME-Version: 1.0' . $this->newline;
          ...
          if (!empty($this->orderreviews_bcc)) {
          	if(VERSION > "2.2.0.0"){
          		$header .= 'Bcc: ' . $this->orderreviews_bcc . $this->newline;
          	} else {
				$header .= 'Bcc: ' . $this->orderreviews_bcc . PHP_EOL;
          	}
          }
