      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-store" class="form-horizontal">
          <ul class="nav nav-tabs">
			...
			<?php if (!(preg_match("/2.0.0/i", VERSION) || preg_match("/2.0.1/i", VERSION) || preg_match("/2.1/i", VERSION))) { ?>
          ...
          <div class="tab-content">
			...
			<?php if (preg_match("/2.0.0/i", VERSION) || preg_match("/2.0.1/i", VERSION)) { ?>
				<div class="form-group">
					<label class="col-sm-2 control-label"><span data-toggle="tooltip" data-html="true" title="<?php echo $help_google_analytics; ?>"><?php echo $entry_google_analytics; ?></span></label>
					<div class="col-sm-10">
						<textarea name="config_google_analytics" rows="5" class="form-control"><?php echo $config_google_analytics; ?></textarea>
					</div>
				</div>
			<?php } ?>
			...
			<?php if (!(preg_match("/2.0.0/i", VERSION) || preg_match("/2.0.1/i", VERSION) || preg_match("/2.1/i", VERSION))) { ?>
				<fieldset>
					<div class="form-group">
						<label class="col-sm-2 control-label"><span data-toggle="tooltip" title="<?php echo $help_google_analytics; ?>"><?php echo $entry_google_analytics; ?></span></label>
						<div class="col-sm-10">
							<textarea name="config_google_analytics" rows="5" class="form-control"><?php echo $config_google_analytics; ?></textarea>
						</div>
					</div>
