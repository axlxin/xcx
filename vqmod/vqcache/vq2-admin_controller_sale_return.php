...
class ControllerSaleReturn extends Controller {
	...
	protected function getList() {
     ...
     'pdf_link'          => $this->model_sale_order->getOrder($result['order_id']) ? $this->url->link('sale/return/pdf', 'token=' . $this->session->data['token'] . '&return_id=' . $result['return_id'] . '&order_id=' . $result['order_id'] . $url, 'SSL') : '',
