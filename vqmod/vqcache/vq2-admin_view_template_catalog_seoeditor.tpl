...
<td><input type="text" name="filter_meta_title" value="<?php echo $filter_meta_title; ?>" /></td>
			...
			<?php if ($product['meta_title'] <> -1) { ?>
				   <td class="edit_td">
					...
					<textarea style="width:180px;" class="editbox" id="meta_title_input_<?php echo $product['type'].$product['id']; ?>"/><?php echo $product['meta_title']; ?></textarea>
				  </td>
			  <?php } else { ?>
