...
<td class="left"><b>Product Custom H2 Generator</b></td>
			...
			<tbody>
              <tr>
<td class="left"><b>Custom Image Titles Generator</b></td>
...
<p><a onclick="clearseo('Custom Image Titles', '<?php echo $clearimgtitles; ?>');" class="button" style="background:red">Clear Custom Image Titles</a></p>
