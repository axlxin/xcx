...
$('#button-refresh').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/cart/products&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		dataType: 'json',
...
$('select[name=\'currency\']').on('change', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/currency&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-customer').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/customer&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				$.ajax({
					url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/cart/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					type: 'post',
				...
				$.ajax({
					url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/voucher/add&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					type: 'post',
...
$('#tab-cart').delegate('.btn-danger', 'click', function() {
	...
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/cart/remove&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-payment-address').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/payment/address&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Payment Methods
				$.ajax({
					url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/payment/methods&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-address').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/shipping/address&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				// Shipping Methods
				$.ajax({
					url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/shipping/methods&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
					dataType: 'json',
					beforeSend: function() {
...
$('#button-shipping-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/shipping/method&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-payment-method').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/payment/method&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-coupon').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/coupon&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-voucher').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/voucher&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-reward').on('click', function() {
	$.ajax({
		url: 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/reward&store_id=' + $('select[name=\'store_id\'] option:selected').val(),
		type: 'post',
...
$('#button-save').on('click', function() {
	...
	if (order_id == 0) {
		var url = 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/order/add&store_id=' + $('select[name=\'store_id\'] option:selected').val();
	} else {
		var url = 'index.php?route=sale/order/api&order_id=<?php echo $order_id; ?>&token=<?php echo $token; ?>&api=api/order/edit&store_id=' + $('select[name=\'store_id\'] option:selected').val() + '&order_id=' + order_id;
	}
