            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><?php if ($return['pdf_link']) { ?><a href="<?php echo $return['pdf_link']; ?>" target="_blank" data-toggle="tooltip" title="PDF" class="btn btn-warning"><i class="fa fa-file-pdf-o"></i></a><?php } ?>
      <a href="<?php echo $return['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
