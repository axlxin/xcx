...
class ControllerProductProduct extends Controller {
	...
	public function index() {
            ...
            $data['yotpo_review_tab_name'] = $this->config->get('yotpo_review_tab_name');
            $data['yotpo_widget_location'] = $this->config->get('yotpo_widget_location');            
            $data['yotpo_bottom_line_enabled'] = $this->config->get('yotpo_bottom_line_enabled');
					...
					if (!$option_value['subtract'] || ($option_value['quantity'] > 0)) {
						...
						$product_option_value_data[] = array(
							...
							'name'                    => $option_value['name'],
								'if_default'                 => $option_value['if_default'],
...
$data['description'] = ($product_info['custom_h2'] != '')?'<h2>'.$product_info['custom_h2'].'</h2>'.$data['description']:$data['description'];
            ...
            $data['product_description'] = substr(strip_tags(html_entity_decode($this->data['description'])),0,1000);
            $data['product_url'] = HTTP_SERVER . 'index.php?route=product/product&product_id=' . $this->request->get['product_id'];
