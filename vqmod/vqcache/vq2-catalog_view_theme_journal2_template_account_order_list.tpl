        ...
        <table class="table table-bordered table-hover list">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right"><?php if(!($pdf_invoice_invoiced && !$order['invoice_no'])){ ?><a href="<?php echo $order['pdf_href']; ?>" target="_new" data-toggle="tooltip" title="<?php echo $button_pdfinv_invoice; ?>" class="btn btn-info btn-primary"><i class="fa fa-file-pdf-o"></i></a><?php } ?> <a href="<?php echo $order['href']; ?>" data-toggle="tooltip" title="<?php echo $button_view; ?>" class="btn btn-info btn-primary"><i class="fa fa-eye"></i></a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
