...
if (json['shipping_method'][i]['quote'][j]['image']) { html += '<img src="' + json['shipping_method'][i]['quote'][j]['image'] + '" alt="' + json['shipping_method'][i]['quote'][j]['title'] + '" title="' + json['shipping_method'][i]['quote'][j]['title'] + '" class="img-thumbnail" />'; }
							html += json['shipping_method'][i]['quote'][j]['title'] + ' - ' + json['shipping_method'][i]['quote'][j]['text']; if (json['shipping_method'][i]['quote'][j]['instruction']) { html += '<br />' + json['shipping_method'][i]['quote'][j]['instruction']; } html += '</label></div>';
						}
					} else {
