<div class="checkout-content">
  ...
  <div class="radio">
    <label>
      ...
      <?php } ?>
<?php if (isset($quote['image']) && $quote['image']) { ?><img src="<?php echo $quote['image']; ?>" alt="<?php echo $quote['title']; ?>" title="<?php echo $quote['title']; ?>" class="img-thumbnail" /><?php } ?>
      <?php echo $quote['title']; ?> - <?php echo $quote['text']; ?><?php if (isset($quote['instruction']) && $quote['instruction']) { ?><br /><?php echo $quote['instruction']; ?><?php } ?></label>
  </div>
  <?php } ?>
  <?php } else { ?>
