  ...
  // multi image uploader
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$a = $this->response->redirect($this->url->link('catalog/product', 'token=' . $this->session->data['token'] . $url, 'SSL'));
		}
...
$data['text_optionsetdefault'] = $this->language->get('text_optionsetdefault');
        ...
        $this->load->language('catalog/kp_option_calculate');
...
$data['entry_custom_imgtitle'] = $this->language->get('entry_custom_imgtitle');
		...
		$data['entry_meta_keyword'] = $this->language->get('entry_meta_keyword');
                $data['entry_misspelling_keyword'] = $this->language->get('entry_misspelling_keyword');
...
'if_default'                => $product_option_value['if_default'],
		...
		foreach ($data['product_options'] as $product_option) {
            ...
            $data['KP_product_option_calculate'] = $this->model_catalog_KP_option_calculate->getProductCalculateCode($this->request->get['product_id']);
                }
                else
                {
                    $data['KP_product_option_calculate'] = '';
                }
