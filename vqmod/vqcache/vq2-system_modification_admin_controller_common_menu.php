...
class ControllerCommonMenu extends Controller {
	...
	$this->load->language('common/menu');
			...
			if (in_array('pdf_invoice', $this->model_extension_extension->getInstalled('module'))) {
				...
				$data['link_pdfinvpro'] = $this->url->link('module/pdf_invoice', 'token=' . $this->session->data['token'], 'SSL');
			} else {
				$data['text_pdfinvpro'] = 'Install PDF Invoice Pro';
				$data['link_pdfinvpro'] = $this->url->link('extension/module/install', 'extension=pdf_invoice&token=' . $this->session->data['token'], 'SSL');
			}
	...
	$middle_code='';
	if (!isset($mass_p_u_menus)) { $mass_p_u_menus=array(); }
	$mass_p_u_menus[1300]='<li><a href="'.$this->url->link('tool/masspstockupd', 'token=' . $this->session->data['token'], 'SSL').'">'.$this->language->get('masstxt_menu_quantity').'</a></li>';
	ksort($mass_p_u_menus);
	foreach ($mass_p_u_menus as $mass_p_u_menu) { $middle_code.=$mass_p_u_menu; }
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
	...
	$middle_code='';
	if (!isset($mass_p_u_menus)) { $mass_p_u_menus=array(); }
	$mass_p_u_menus[1200]='<li><a href="'.$this->url->link('tool/massppriceupd', 'token=' . $this->session->data['token'], 'SSL').'">'.$this->language->get('masstxt_menu_price').'</a></li>';
	ksort($mass_p_u_menus);
	foreach ($mass_p_u_menus as $mass_p_u_menu) { $middle_code.=$mass_p_u_menu; }
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
	...
	$middle_code='';
	if (!isset($mass_p_u_menus)) { $mass_p_u_menus=array(); }
	$mass_p_u_menus[1900]='<li><a href="'.$this->url->link('tool/masspoptiupd', 'token=' . $this->session->data['token'], 'SSL').'">'.$this->language->get('masstxt_menu_options').'</a></li>';
	ksort($mass_p_u_menus);
	foreach ($mass_p_u_menus as $mass_p_u_menu) { $middle_code.=$mass_p_u_menu; }
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
	...
	$middle_code='';
	if (!isset($mass_p_u_menus)) { $mass_p_u_menus=array(); }
	$mass_p_u_menus[1500]='<li><a href="'.$this->url->link('tool/masspmanufupd', 'token=' . $this->session->data['token'], 'SSL').'">'.$this->language->get('masstxt_menu_manufacturer').'</a></li>';
	ksort($mass_p_u_menus);
	foreach ($mass_p_u_menus as $mass_p_u_menu) { $middle_code.=$mass_p_u_menu; }
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
	...
	$middle_code='';
	if (!isset($mass_p_u_menus)) { $mass_p_u_menus=array(); }
	$mass_p_u_menus[2100]='<li><a href="'.$this->url->link('tool/massplayoutupd', 'token=' . $this->session->data['token'], 'SSL').'">'.$this->language->get('masstxt_menu_price').'</a></li>';
	ksort($mass_p_u_menus);
	foreach ($mass_p_u_menus as $mass_p_u_menu) { $middle_code.=$mass_p_u_menu; }
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
	
	$this->load->language('tool/masspfiltersupd');
	$begin_code='<li><a class="parent">'.$this->language->get('masstxt_menu1').'</a><ul>';
	$end_code='</ul></li>';
	$middle_code='';
	if (!isset($mass_p_u_menus)) { $mass_p_u_menus=array(); }
	$mass_p_u_menus[1700]='<li><a href="'.$this->url->link('tool/masspfiltersupd', 'token=' . $this->session->data['token'], 'SSL').'">'.$this->language->get('masstxt_menu_filters').'</a></li>';
	ksort($mass_p_u_menus);
	foreach ($mass_p_u_menus as $mass_p_u_menu) { $middle_code.=$mass_p_u_menu; }
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
	...
	$middle_code='';
	if (!isset($mass_p_u_menus)) { $mass_p_u_menus=array(); }
	$mass_p_u_menus[2000]='<li><a href="'.$this->url->link('tool/masspdiscoupd', 'token=' . $this->session->data['token'], 'SSL').'">'.$this->language->get('masstxt_menu_disco_spec').'</a></li>';
	ksort($mass_p_u_menus);
	foreach ($mass_p_u_menus as $mass_p_u_menu) { $middle_code.=$mass_p_u_menu; }
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
	...
	$middle_code='';
	if (!isset($mass_p_u_menus)) { $mass_p_u_menus=array(); }
	$mass_p_u_menus[1400]='<li><a href="'.$this->url->link('tool/masspdwupd', 'token=' . $this->session->data['token'], 'SSL').'">'.$this->language->get('masstxt_menu_d_w').'</a></li>';
	ksort($mass_p_u_menus);
	foreach ($mass_p_u_menus as $mass_p_u_menu) { $middle_code.=$mass_p_u_menu; }
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
	...
	$data['mass_p_u_code']=$begin_code.$middle_code.$end_code;
		...
		$data['text_error_log'] = $this->language->get('text_error_log');
            ...
            $data['text_export_customers'] = $this->language->get('text_export_customers');
...
$data['text_rewards'] = $this->language->get('text_rewards');
		...
		$data['text_openbay_order_import'] = $this->language->get('text_openbay_order_import');
				...
				$data['gcrdev_sitemap_2'] = $this->language->get('gcrdev_sitemap_2');
		...
		$data['error_log'] = $this->url->link('tool/error_log', 'token=' . $this->session->data['token'], 'SSL');
            ...
            $data['export_customers'] = $this->url->link('tool/export_customers', 'token=' . $this->session->data['token'], 'SSL');
...
$data['rewards'] = $this->url->link('catalog/rewards', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['order_recurring'] = $this->url->link('sale/recurring', 'token=' . $this->session->data['token'], 'SSL');
				...
				$data['gcrdev_sitemap_2_page'] = $this->url->link('feed/gcrdev_sitemap', 'token=' . $this->session->data['token'], 'SSL');
			
                $data['pcb_assembling_inquiry'] = $this->url->link('sale/pcb_assembling_inquiry', 'token=' . $this->session->data['token'], 'SSL');
