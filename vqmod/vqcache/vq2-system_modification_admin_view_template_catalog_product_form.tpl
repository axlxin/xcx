        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="text-left">
                        <textarea rows="15" cols="100" name="KP_product_option_calculate"><?php echo $KP_product_option_calculate; ?></textarea>
...
html += '        <td class="text-left"><?php echo $text_optionsetdefault; ?></td>';
