...
<button type="submit" id="button-sfcExporter" form="form-order" formaction="<?php echo HTTP_CATALOG ?>express_exporter/sfc.php" data-toggle="tooltip" title="SFC数据导出" class="btn btn-info">SFC数据导出</button>
<button type="submit" id="button-DHLExporter" form="form-order" formaction="<?php echo HTTP_CATALOG ?>express_exporter/dhl.php" data-toggle="tooltip" title="DHL数据导出" class="btn btn-info">DHL数据导出</button>


<button type="button"  data-toggle="tooltip" title="导出订单" class="btn btn-info" onclick="KPOpenDialog();">导出订单</button>


<button type="submit" id="button-sfcExporter" form="form-order" formaction="<?php echo HTTP_CATALOG ?>sfc_exporter/index.php" data-toggle="tooltip" title="SFC数据导出" class="btn btn-info">SFC数据导出</button>
				...
				<button type="submit" id="btn-pdfinv-packing" form="form-order" formaction="<?php echo $link_pdfinv_packing; ?>" data-toggle="tooltip" title="<?php echo $button_pdfinv_packing; ?>" class="btn btn-warning"><i class="fa fa-file-text-o"></i></button>
				<?php if($pdf_invoice_manual_backup) { ?>
...
$('#btn-pdfinv-invoice, #btn-pdfinv-packing, #btn-pdfinv-backup').prop('disabled', true);
