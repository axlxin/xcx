...
// Clear Thinking: MailChimp Integration Pro
	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			/*OrderReviews customer group query */
...
// Clear Thinking: MailChimp Integration Pro
			...
			$this->db->query("INSERT INTO " . DB_PREFIX . "order_history SET order_id = '" . (int)$order_id . "', order_status_id = '" . (int)$order_status_id . "', notify = '" . (int)$notify . "', comment = '" . $this->db->escape($comment) . "', date_added = NOW()");
				...
				$this->load->model('module/orderreviews');
				$this->model_module_orderreviews->sendReviewMail($order_id, $order_status_id);
			...
			if (!$order_info['order_status_id'] && $order_status_id) {
				...
				if($this->config->get('pdf_invoice_mail') || ($this->config->get('pdf_invoice_backup') && $this->config->get('pdf_invoice_backup_moment') == 'order')){
